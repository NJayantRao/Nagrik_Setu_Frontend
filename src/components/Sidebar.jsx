...
function Sidebar(){
    ...
    return(
        <div className="bg-[#ECFDF5] flex flex-col h-screen w-60 left-0 top-0 p-4 ">
           <div className="flex flex-col gap-3 overflow-y-auto h-[78vh] scrollbar-hide">
            ...
            <div className="flex items-center gap-3 px-4 py-3 text-gray-700 font-bold bg-[#D1FAE5] rounded-2xl transition cursor-pointer hover:scale-105 hover:bg-[#A7F3D0]">
                ...
                <h2>My Profile</h2>
                  ...
                  <div className="bg-[#D1FAE5] p-4 rounded-lg  hover:scale-105 hover:bg-[#A7F3D0]">
        ...
        <div className="text-gray-500 text-sm mt-1">ID:ldf-dfss-8878744333</div>
        </div>

        <div className="bg-[#D1FAE5] flex justify-center items-center p-2 hover:scale-105 hover:bg-[#A7F3D0]">
