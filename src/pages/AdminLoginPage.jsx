...
function AdminLoginPage(){
    ...
    const{adminName,setAdminName,adminEmail,setAdminEmail,adminPassword,setAdminPassword,adminAddress,setAdminAddress,adminPhone,setAdminPhone,adminUniqueId,setAdminUniqueId}= useContext(AdminDataContext)
  ...
  toast[type](message, {
    ...
    async function submitHandler(e){
        ...
        try {
            const response= await axios.post(`${import.meta.env.VITE_LOCAL_URL}/admin/login`,{
                uniqueId:adminUniqueId,password:adminPassword
